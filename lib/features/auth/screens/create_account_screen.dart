...
import 'package:dropdown_search/dropdown_search.dart'; // استيراد مكتبة dropdown_search
...
class _CreateAccountScreenState extends State<CreateAccountScreen> {
  ...
  List<Map<String, dynamic>> governorates = [
    ...
    {"id": "28", "governorate_name_ar": "   ", "governorate_name_en": "   "}
  ];
  ...
  List<Map<String, dynamic>> typeOfActivity = [
    {"id": "1", "name": "سوبر ماركت"},
    {"id": "2", "name": "كشك"},
    {"id": "3", "name": "ماركت"},
    {"id": "4", "name": "محل شكولاته"},
    {"id": "5", "name": "محمصه"},
    {"id": "6", "name": "عطاره"},
    {"id": "7", "name": "جيم"},
    {"id": "8", "name": "كافيه"},
    {"id": "9", "name": "مطعم"},
    {"id": "10", "name": "بوفيه شركة"},
    {"id": "11", "name": "   "},
  ];
  ...
  void initState() {
    ...
    selectedGovernorate = governorates[27]['governorate_name_ar'];
    selectedCity = "   ";
    selectedPlatform = typeOfActivity[10]['name'];
    super.initState();
  }

  List<Map<String, dynamic>> getCitiesByGovernorate(String governorateId) {
    return cities
            ...
            slivers: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // for refer code section
                              //   Column(
                              //     crossAxisAlignment: CrossAxisAlignment.start,
                              //     children: [
                              //       Text(
                              //         getTranslated('refer_code', context),
                              //         style: poppinsRegular.copyWith(color: Theme.of(context).hintColor.withOpacity(0.6)),
                              //       ),
                              //       const SizedBox(height: Dimensions.paddingSizeSmall),
                              //
                              ...
                              DropdownSearch<String>(
                                items: governorates
                                    .map((e) =>
                                        e['governorate_name_ar'] as String)
                                    .toList(),
                              ...
                              DropdownSearch<String>(
                                items: selectedGovernorate == null
                                    ...
                                    : getCitiesByGovernorate(
                                            governorates.firstWhere((gov) =>
                                                gov['governorate_name_ar'] ==
                                                selectedGovernorate)['id'])
                                        .map((e) => e['city_name_ar'] as String)
                                        .toList(),
                              ...
                              const SizedBox(
                                  height: Dimensions.paddingSizeLarge),
                              // إضافة القائمة المنسدلة الخاصة بـ "بلات فورم"
                              Text(
                                getTranslated('type_of_activity', context),
                                style: poppinsRegular.copyWith(
                                  color: Theme.of(context)
                                      .hintColor
                                      .withOpacity(0.6),
                              ...
                              // for already have account section
              ...
              ResponsiveHelper.isDesktop(context)
                  ? const SliverToBoxAdapter(
                      child: FooterWebWidget(footerType: FooterType.sliver),
                    )
                  : const SliverToBoxAdapter(),
            ],
          ),
  ...
  void _onSignUpPress(ConfigModel config) {
    ...
    int governmentId = int.parse(governorates.firstWhere(
        (gov) => gov['governorate_name_ar'] == selectedGovernorate)['id']);
    int cityId = int.parse(cities
        .firstWhere((city) => city['city_name_ar'] == selectedCity)['id']);
    int platformId = int.parse(typeOfActivity.firstWhere(
    ...
    if (firstName.isEmpty) {
      ...
      showCustomSnackBarHelper("من فضلك اختار المحافظة");
    } else if (selectedCity == "   ") {
      showCustomSnackBarHelper("من فضلك اختار المدينة");
    } else if (selectedPlatform == "   ") {
      showCustomSnackBarHelper("من فضلك اختار اين تعرفت علينا");
    } else {
      ...
      authProvider.registration(signUpModel, config).then(
        (status) async {
          if (status.isSuccess) {

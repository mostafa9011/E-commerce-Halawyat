...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ResponsiveHelper.isMobilePhone() ? AppBar(leading: IconButton(icon: Icon(Icons.arrow_back_ios_new,),onPressed: ()=>Navigator.of(context).pop()),): (ResponsiveHelper.isDesktop(context)? const PreferredSize(preferredSize: Size.fromHeight(120), child: WebAppBarWidget()) : const AppBarBaseWidget()) as PreferredSizeWidget?,
      body: Center(
